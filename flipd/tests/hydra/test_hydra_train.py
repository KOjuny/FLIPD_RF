...
fpk_mnist = [
    ...
    "train.trainer.fast_dev_run=True",
    "+train.trainer.devices=1",  # set it to 1 for efficiency
    "+callbacks@all_callbacks.lid=flipd_curve",
    "all_callbacks.lid.frequency=1",
    "all_callbacks.lid.subsample_size=10",
    "all_callbacks.lid.sweeping_range.num=3",
    "all_callbacks.lid.lid_estimation_args.chunk_size=8",
    "+all_callbacks.lid.lid_estimation_args.hutchinson_sample_count=1",
    "all_callbacks.lid.lid_estimation_args.method=hutchinson_gaussian",
    "all_callbacks.lid.batch_size=10",
]
...
all_settings = [
    ...
    (13, "dev_fpk_mnist", fpk_mnist),
    (14, "dev_lidl_lollipop", lidl_lollipop),
]
